...
@IBDesignable class Rainbow: UIView {
    ...
    @IBInspectable var innerRadius: CGFloat = 80
    @IBInspectable var midRadius: CGFloat = 150
    @IBInspectable var outerRadius: CGFloat = 215
    ...
    override func draw(_ rect: CGRect){
        self.addCirle(arcRadius: self.innerRadius, capRadius: 20, color: self.firstColor)
        self.addCirle(arcRadius: self.midRadius, capRadius: 20, color: self.secondColor)
        self.addCirle(arcRadius: self.outerRadius, capRadius: 20, color: self.thirdColor)
    }
